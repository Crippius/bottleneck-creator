...
/*
 * FIXED: float (SP) instead of double (DP), compiled at -O2 -march=native.
 ...
 *
 * This file MUST be compiled with -O2 -march=native; at -O0 the compiler
 * issues plain scalar SP instructions and the ratio still shows waste.
 */
